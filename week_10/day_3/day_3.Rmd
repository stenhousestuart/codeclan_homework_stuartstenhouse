...
Re-running `ggpairs()` using these new variables, there still appears to be a strong correlation between `price_log` and `sqft_living_log`. I will therefor proceed in using `sqft_living_log` as my first predictor.
