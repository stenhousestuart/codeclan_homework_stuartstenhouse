...
Interpretation:
Based on the plot below where a fitted normal distribution has been plotted over our probability density data, I would be leaning towards normal distribution not being a good model of these ratings. This is due to a number of ratings falling outwith the normal distribution at at both the lower and higher ends.
...
- Considering the QQPLot and QQline, this would suggest that this data does not fit a normal distribution.

- Considering the Skewness of the data -0.9349111, it is moderately negatively skewed.
