...
For now, I will remove `weekof_purchase` entirely.
...
loyal_ch / Statitically Significant / B1 Coefficient -6.0948
disc_ch / Statitically Significant / B1 Coefficient -3.9819
list_price_diff / Statitically Significant / B1 Coefficient -3.1438
price_diff / Statitically Significant / B1 Coefficient -2.16873
disc_mm / Statitically Significant / B1 Coefficient 1.57365
store_id / IDs 3, 4 & 7 Statitically Significant.
...
juice_model_5_pred_b / purchase_mm ~ loyal_ch + disc_ch + list_price_diff + price_diff + store_id / 0.9022
...
juice_model_4_pred
purchase_mm ~ loyal_ch + disc_ch + list_price_diff + price_diff
AUC 0.8999 / Cross Validated 0.8982
AUC Dif. 0.0017
...
- None of the models have a large decrease in AUC following Cross Validation, suggesting that none of the models are overfit.
...
- With the above in mind, to balance AUC score with simplificity, I would interpret the below moddle as being the best predictove classifier in this instance:
