...
highlight_colours <- c("highlight" = "firebrick", "standard" = "#0391BF")
...
cancer_incidence_borders %>% 
  ...
  annotate("text", x = 1999, y = 215, label = "+93%", size = 3, face = "bold", colour = "#6B077B") +
  annotate("segment", x = 2002, xend = 2002, y = 200, yend = 150,
           colour = "#6B077B", size = 0.5, arrow = arrow()) +
  annotate("text", x = 2002, y = 215, label = "+62%", size = 3, face = "bold", colour = "#6B077B") +
  annotate("segment", x = 2005, xend = 2005, y = 250, yend = 200,
           colour = "#6B077B", size = 0.5, arrow = arrow()) +
  annotate("text", x = 2005, y = 265, label = "+189%", size = 3, face = "bold", colour = "#6B077B") +
  annotate("segment", x = 2008, xend = 2008, y = 225, yend = 175,
           colour = "#6B077B", size = 0.5, arrow = arrow()) +
  annotate("text", x = 2008, y = 240, label = "+180%", size = 3, face = "bold", colour = "#6B077B") +
  annotate("segment", x = 2011, xend = 2011, y = 225, yend = 175,
           colour = "#6B077B", size = 0.5, arrow = arrow()) +
  annotate("text", x = 2011, y = 240, label = "+83%", size = 3, face = "bold", colour = "#6B077B") +
  annotate("segment", x = 2014, xend = 2014, y = 200, yend = 150,
           colour = "#6B077B", size = 0.5, arrow = arrow()) +
  annotate("text", x = 2014, y = 215, label = "+14%", size = 3, face = "bold", colour = "#6B077B") +
  annotate("segment", x = 2017, xend = 2017, y = 200, yend = 150,
           colour = "#6B077B", size = 0.5, arrow = arrow()) +
  annotate("text", x = 2017, y = 215, label = "+39%", size = 3, face = "bold", colour = "#6B077B") +
  annotate("segment", x = 2021, xend = 2021, y = 220, yend = 170,
           colour = "#6B077B", size = 0.5, arrow = arrow()) +
  annotate("text", x = 2021, y = 235, label = "+39%", size = 3, face = "bold", colour = "#6B077B") +
...
- Breast Cancer screening data should be reviewed in order to establish whether screening originally due in 2020 was fully caught up on in 2021, or whether further increases in incidences in 2022 can be expected due to ongoing knock-on effects of screening disruption. Resources should then be allocated accordingly.

- Resources should be allocated in-line with the observed trend of increased incidences every three years.
