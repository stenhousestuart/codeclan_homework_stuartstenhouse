...
backpacks %>% 
  ...
  labs(
    ...
    title = "Average Backpack Weight by Sex")

```
Summary:
- The average weight of male backpacks is higher than the average weight of female backpacks.
...
Summary:
Just over 30% of students have reported backpain.
